...
import (
	...
	"github.com/mangolau/instrument_trace/instrumenter"
	"github.com/mangolau/instrument_trace/instrumenter/ast"
)
...
func main() {
	...
	ins = ast.New("github.com/mangolau/instrument_trace", "trace", "Trace")
